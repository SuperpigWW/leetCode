...
public class MaxHeap<T extends Comparable<? super T>> {
     ...
     *                                            is null
     */
    public MaxHeap(java.util.ArrayList<T> data) {
        if (data == null) {
            throw new IllegalArgumentException("Cannot initialize heap with null data.");
        }
    ...
    /**
     * Private helper method to perform upheap operation.
     *
     * @param index the index to start upheap from
     */
    ...
    /**
     * Private helper method to perform downheap operation.
     *
     * @param index the index to start downheap from
     */
