 ...
 * on a descending (reverse-sorted) ArrayList.
 *
...
public class MergeSortDescendingTimingExperiment extends TimingExperiment {
    ...
    /**
     * Generates a new descending ArrayList for each timing iteration.
     *
    ...
    public static void main(String[] args) {
        TimingExperiment experiment = new MergeSortDescendingTimingExperiment();
        System.out.println("=== Merge Sort - Descending ArrayList ===");
