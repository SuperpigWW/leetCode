...
public class Song {
	...
	public void addNoteEvent(int time, int trackNumber, int duration, int pitch) {
		...
		//        See https://docs.oracle.com/en/java/javase/21/docs/api/java.base/java/util/Collections.html#sort(java.util.List)
	...
	public void clearAll() {
		// TODO - Fill in to clear the ArrayLists for all tracks.
	}
