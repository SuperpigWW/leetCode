...
public class FacilityTester {
	...
	@Test
	public void testSmallLookupByUHIDNotFound() {
		assertNull(smallFacility.lookupByUHID(new UHealthID("BCBC-2323")));
	}

	@Test
	public void testSmalllookupByPhysician() {
		Patient expectedPatient = new Patient("Samantha", "Schooner", new UHealthID("OUDC-6143"));
		ArrayList<CurrentPatient> actualPatients = smallFacility.lookupByPhysician(1111111);
		assertEquals(expectedPatient, actualPatients.get(0));
	}

	@Test
	public void testSmallAddNewPatient() {
		assertTrue(smallFacility.addPatient(new CurrentPatient("Blake", "Bird", new UHealthID("ZZZZ-9999"), 0000000,
				new GregorianCalendar(2000, 2, 3))));
	}

	@Test
	public void testSmallUpdatePhysician() {
		smallFacility.lookupByUHID(new UHealthID("OUDC-6143")).updatePhysician(9090909);
