...
public class StudentGoodHash {
	...
	/**
	 * Returns a hash code computed from all three fields: uid, firstName, and
	 * lastName. A polynomial rolling hash with prime multiplier 31 is used to
	 * thoroughly mix the bit patterns of each field, minimising clustering and
	 * producing an even distribution across buckets. This mirrors the strategy
	 * used by Java's own String.hashCode() and is intentionally a well-designed
	 * hash function for experimental comparison purposes.
	 *
	 * @return a hash code derived from uid, firstName, and lastName
	 */
	public int hashCode() {
		return 31 * (uid + 31 * firstName.hashCode()) + lastName.hashCode();
	}
}
